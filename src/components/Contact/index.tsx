...
const Contact = () => {
  const { formData, formRef, isSubmitting, submitted, failed, handleInputChange, handleSubmit } = useContact();
      ...
      <section className="container">
        ...
        <div className="content-grid">
            ...
            <div className="form-wrapper">
              ...
              <form ref={formRef} onSubmit={handleSubmit}>
                ...
                <div className="input-group">
                  ...
                  <div className="input-wrapper">
                    <MessageSquare className="icon" size={18} style={{ top: "15%" }} />
                    <textarea
                      id="message"
                      name="message"
                      required
                ...
                <button type="submit" disabled={isSubmitting}>
                  {isSubmitting ? <div className="spinner" /> : <Send size={18} />}
                  {isSubmitting ? "전송 중..." : "메시지 보내기"}
                </button>

                {submitted && (
                  <div className="success-message">메시지를 보내주셔서 감사합니다! 곧 연락드리겠습니다.</div>
                )}

                {failed === true && <div className="failed-message">오류가 발생했습니다. 다시 시도해주세요.</div>}
              </form>
            </div>
          </div>
          ...
          <div className="sidebar">
            ...
            <div className="info-card">
              <h1>소셜 미디어</h1>
              <a className="social-link" href="https://github.com/wjzlskxk" target="_blank" rel="noreferrer">
              ...
              <a className="social-link" href="https://velog.io/@wjzlskxk/posts" target="_blank" rel="noreferrer">

      ...
      <div className="categories-section">
        ...
        <div className="category-list">
          {skillCategories.map((category, categoryIndex) => (
            <div key={category.title} className="category-block" style={{ animationDelay: `${categoryIndex * 200}ms` }}>
              ...
              <div className="skills-grid">
                {category.skills.map((skill, skillIndex) => (
                  <div key={skill.name} className="skill-card" style={{ animationDelay: `${skillIndex * 100}ms` }}>
                    <div className="glow" />
                    <div className="card-content">
                      ...
                      <div className="progress-bar">
                        <div
                          className={`progress-fill ${getSkillLevelColor(skill.level)}`}
                          style={{
                            width: `${skill.level}%`,
                            borderRadius: 0,
                          }}
                        />
                        <div className="progress-indicator" style={{ left: `${skill.level}%` }} />
                      </div>
